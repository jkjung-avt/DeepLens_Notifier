...
Example usage:
 $ python3 ./object_detection_demo_ssd_async.py \
           -m /home/aws_cam/models/openvino/googlenet_fc_coco_SSD_300x300/FP16/deploy.xml \
           -d GPU \
           -i /opt/awscam/out/ch2_out.mjpeg
"""
...
def main():
    ...
    if args.input == 'cam':
        ...
        assert os.path.exists(args.input), "Specified input file doesn't exist"
    if args.labels:
    ...
    while cap.isOpened():
        ...
        #initial_h = cap.get(4)
        if is_async_mode:
            next_frame = cv2.resize(next_frame, (640, 360))
        else:
